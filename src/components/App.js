...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const profileCount2 = await decentragram.methods.profileCount2().call()
      ...
      else if(this.state.account==this.state.account2){
      ...
      else if(this.state.account==this.state.account3){
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      profiles1:[],
      profiles2:[],
      account1:"0xef7419F31741E16997f15277464eE47a101E2034",
      account2:"0x1Cc1F19921632B15B30f62572d5A14A39F10b82a",
      account3:"0x39d2B119B660F852eedA72E8751956b5Fc15D34e",
      p1:0,
      p2:0,
      d:0,
