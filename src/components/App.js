...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const profileCount2 = await decentragram.methods.profileCount2().call()
      ...
      if(this.state.account=="0x272b4072de19DF4cf948Af98DaEa272CdAeD8267"){
      ...
      else if(this.state.account=="0x87142617dd0627e9a4eeDcc0102Ef39ba6D6107A"){
      ...
      else if(this.state.account=="0x11b7d97F38B45116162F7F5613846f9D8faDa293"){
