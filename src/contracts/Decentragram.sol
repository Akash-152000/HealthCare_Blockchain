...
contract Decentragram {
  ...
  function uploadImage(string memory _imgHash, string memory _description,uint _num) public {
    ...
    if(_num==1){
      ...
      images1[patient1Count] = Image1(patient1Count, _imgHash, _description, _num,0, msg.sender);
      // Trigger an event
      emit ImageCreated1(patient1Count, _imgHash, _description,_num, 0, msg.sender);
    }
    else{
      // Increment image id
      patient2Count ++;
      ...
      // Add Image to the contract
      images2[patient2Count] = Image2(patient2Count, _imgHash, _description, _num,0, msg.sender);
      // Trigger an event
      emit ImageCreated2(patient2Count, _imgHash, _description,_num, 0, msg.sender);
    }
